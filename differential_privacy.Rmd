...
In ... Arvind Narayanan and Vitaly Shmatikov sucessfully deanonymized the Netflix competition data by attacking with the IMDB database as an external source.
...
Using the laplace mechanism to renders these queries differentiably private
