...
We can resolve this by viewing the summation as a query into our training set

$$ f(s) = \sum_{j \mid x_j = s} y_j $$

and using the laplace mechanism to render it differentiably private!
